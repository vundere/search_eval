...
ATTR = [Attribute("Location", AttrType.cat), Attribute("W", AttrType.cat),
        ...
        Attribute("Period", AttrType.cat), Attribute("Game_Clock", AttrType.num), Attribute("Shot_Clock", AttrType.num),
        Attribute("Dribbles", AttrType.num), Attribute("Touch_Time", AttrType.num),
        Attribute("Shot_Dist", AttrType.num), Attribute("PTS_Type", AttrType.cat),
